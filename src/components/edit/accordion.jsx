...
export default function Accordion({ title, children, isOpen, setIndex, index }) {
    ...
    return (
        <div className="flex flex-col border-2 rounded-lg overflow-hidden transition-all duration-500" style={isOpen ? {paddingBottom: '15px'} : {paddingBottom: '0px'}}>
            ...
            <div ref={contentHeight} style={isOpen 
                ? {maxHeight: '900px'}
                : {maxHeight: '0px'}}
                className='transition-all duration-500 overflow-y-auto scrollbar scrollbar-track-black scrollbar-thin'
                >
